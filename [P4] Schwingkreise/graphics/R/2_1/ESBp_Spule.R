...
p9 <- ggplot(data.frame(x=c(0, 2),y=c(0,2)), aes(x,y)) +
        ...
        scale_y_continuous(limits=c(-1.23606797749978964,0),  breaks = c(0,-1), labels=c( "",bquote("-"~over(1,omega ~ "L"["s"]))) ) +
        scale_x_continuous(limits=c(0, 1.23606797749978964),  breaks = c(0,Rpos), labels=c("", bquote(over(1,"R"["s"])) ) , position="top")+
