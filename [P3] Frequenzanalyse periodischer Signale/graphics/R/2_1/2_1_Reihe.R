...
wave1 <- function(t) {
  Xm/2 +amplifun(1) * cos(2*pi/T1*t)
}
wave2 <- function(t) {
  Xm/2 +amplifun(2) * cos(2*2*pi/T1*t)
}
wave3 <- function(t) {
  Xm/2 +amplifun(3) * cos(3*2*pi/T1*t)
}
wave4 <- function(t) {
  Xm/2 +amplifun(4) * cos(4*2*pi/T1*t)
}
wave5 <- function(t) {
  Xm/2 +amplifun(5) * cos(5*2*pi/T1*t)
}
wave6 <- function(t) {
  Xm/2 +amplifun(6) * cos(6*2*pi/T1*t)
}
wave7 <- function(t) {
  Xm/2 +amplifun(7) * cos(7*2*pi/T1*t)
}
wave8 <- function(t) {
  Xm/2 +amplifun(8) * cos(8*2*pi/T1*t)
}
wave9 <- function(t) {
  Xm/2 +amplifun(9) * cos(9*2*pi/T1*t)
}
wave10 <- function(t) {
  Xm/2 +amplifun(10) * cos(10*2*pi/T1*t)
}
wave11 <- function(t) {
  Xm/2 +amplifun(11) * cos(11*2*pi/T1*t)
}
wave12 <- function(t) {
  Xm/2 +amplifun(12) * cos(12*2*pi/T1*t)
}
wave13 <- function(t) {
  Xm/2 +amplifun(13) * cos(13*2*pi/T1*t)
}
wave14 <- function(t) {
  Xm/2 +amplifun(14) * cos(14*2*pi/T1*t)
}
wave15 <- function(t) {
  Xm/2 +amplifun(15) * cos(15*2*pi/T1*t)
}

totalwave <- function(t) {

   -Xm/2 * 14 + wave1(t) + wave2(t) + wave3(t) + wave4(t) + wave5(t) + wave6(t) + wave7(t) + wave8(t) + wave9(t) + wave10(t) + wave11(t) + wave12(t) + wave13(t) + wave14(t) + wave15(t)
